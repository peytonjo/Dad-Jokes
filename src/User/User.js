    ...
    return (
      <section className="user-view">
        <article className="user-favs" alt="favorite jokes">
          ...
          {getFavoriteJokes() ? (
            this.makeJokeCards(getFavoriteJokes())
          ) : (
            <p>This is where my favorite jokes would go... IF I HAD ANY</p>
          )}
        </article>
        <article className="users-jokes" alt="created jokes">
          <h1>Your Jokes</h1>
          {getUserJokes() ? (
            this.makeJokeCards(getUserJokes())
          ) : (
            <p>This is where my jokes would go... IF I HAD ANY</p>
          )}
        </article>
      </section>
    );
